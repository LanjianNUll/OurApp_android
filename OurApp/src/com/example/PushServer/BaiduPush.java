...
public class BaiduPush
{
	...
	public final static String mUrl = "http://api.push.baidu.com/rest/2.0/channel/";// 基础url
	...
	public String PostHttpRequest(RestApi data)
	{
		...
		{
			e.printStackTrace();
			Log.v("PostHttpRequest Exception:", e.getMessage());
	...
	private int HttpRequest(String url, String query, StringBuilder out)
	{
		...
		{
			e.printStackTrace();
			Log.v("HttpRequest Exception:" ,e.getMessage());
