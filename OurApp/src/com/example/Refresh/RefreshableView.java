...
public class RefreshableView extends LinearLayout implements OnTouchListener {
	...
	public RefreshableView(Context context, AttributeSet attrs) {
		...
		jiazai = (ImageView) header.findViewById(R.id.jiazai);
		//动画
	...
	private void setIsAbleToPull(MotionEvent event) {
		...
		if (firstChild != null) {
			...
			if (firstVisiblePos == 0 && firstChild.getTop() == 0) {//view.getTop()为获取视图顶部的位置及坐标
				if (!ableToPull) {
					yDown = event.getRawY();//获取相对屏幕的，而getx()是获得当前相对当前view的坐标
				}
