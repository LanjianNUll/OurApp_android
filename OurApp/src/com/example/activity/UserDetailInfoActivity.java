...
public class UserDetailInfoActivity extends Activity {
	...
	private TextView userDetailName, userDetailState, userDetailSex, userDetailNearLocation;
	//留言板
	...
	private void initview() {
		...
		userDetailComeback.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				Intent intent = new Intent(UserDetailInfoActivity.this, MainActivity.class);
